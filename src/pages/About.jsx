...
import { mockQuery } from '../components/certificatesMockData'
...
const AboutPage = () => {
  ...
  const { totalProjects, totalCertificates, YearExperience } = useMemo(() => {
    ...
    // Use mock certificate data since certificates aren't stored in localStorage
    const certificateCount = mockQuery.certificates.length;
  ...
  const statsData = useMemo(() => [
    {
      ...
      description: "Technical & Creative Skills",
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
             I'm a Frontend Web Developer with a passion for creating engaging digital experiences. My journey in web development began with a fascination for technology and design, leading me to specialize in crafting intuitive user interfaces and seamless user experiences. I thrive on challenges and continuously seek to enhance my skills, ensuring that I stay at the forefront of the ever-evolving web landscape.
            </p>
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Leveraging AI as a professional tool, not a replacement."
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/drive/folders/1lhAzGBbzBwguALdqUjDHt8Lxm_msHL1Y" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
