...
const WORDS = ["Technical Support Engineer", "UI/UX Designer", "Graphic Designer", "Web Developer"];
const TECH_STACK = ["CSS", "Javascript", "C++", "Figma"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/JenzenRasheedGaro" },
  { icon: Linkedin, link: "LINK HERE" },
  { icon: Instagram, link: "LINK HERE" }
];
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            ...
            <div className="w-full py-[10%] sm:py-0 lg:w-1/2 h-auto lg:h-[600px] xl:h-[750px] relative flex items-center justify-center order-2 lg:order-2 mt-8 lg:mt-0"
              ...
              <div className="relative w-full opacity-90">
                {/* Removed blur and opacity overlays for GIF clarity */}

                <div className={`relative lg:left-12 z-10 w-full opacity-90 transform transition-transform duration-500 ${
                  isHovering ? "scale-105" : "scale-100"
                }`}>
                  <img
                    src="/gif-unscreen.gif"
                ...
                {/* Removed all blur and opacity overlays for GIF clarity */}
              </div>
            </div>
          </div>
        </div>
